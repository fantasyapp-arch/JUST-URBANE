                  ...
                  <Link to={getArticleRoute(article)}>
                    <div className="relative">
                      <img 
                        ...
                        alt={article.title}
                        className="w-full h-auto object-contain group-hover:scale-105 transition-transform duration-300 min-h-[200px]"
                        onError={(e) => {
                    ...
                    <div className="md:flex">
                      <div className="md:w-1/2">
                        <img 
                          src={article.hero_image}
                          alt={article.title}
                          className="w-full h-auto object-contain group-hover:scale-105 transition-transform duration-300 min-h-[200px] max-h-[300px]"
                          onError={(e) => {
                  ...
                  <Link to={getArticleRoute(article)} className="block">
                    <div className="relative">
                      <img 
                        src={article.hero_image}
                        alt={article.title}
                        className="w-full h-auto object-contain group-hover:scale-105 transition-transform duration-300 min-h-[200px] max-h-[350px]"
                        onError={(e) => {
