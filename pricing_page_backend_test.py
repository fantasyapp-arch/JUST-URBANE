...
class PricingPageBackendTester:
    def __init__(self, base_url: str = "https://premium-urbane-1.preview.emergentagent.com/api"):
    ...
    def test_cors_configuration(self):
        ...
        try:
            ...
            preflight_response = self.session.options(
                ...
                headers={
                    "Origin": "https://premium-urbane-1.preview.emergentagent.com",
            ...
            if preflight_response.status_code in [200, 204]:
                ...
                if allow_origin:
                    ...
                    actual_response = self.session.get(
                        f"{self.base_url}/health",
                        headers={"Origin": "https://premium-urbane-1.preview.emergentagent.com"},
                        timeout=10
                    )
